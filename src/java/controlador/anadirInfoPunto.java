 ...
 * @author Usuario
 */
@WebServlet(name = "anadirInfoPunto", urlPatterns = {"/anadirInfoPunto"})
public class anadirInfoPunto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Generar petición
            os.write("anadirinfopunto#" + idCreador + "#" + privado + "#" + elevar + "#" + lat + "#" + lon + "#" + valores + "#" + "\n");
            os.flush();
