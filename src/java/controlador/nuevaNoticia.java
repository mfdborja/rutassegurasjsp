...
@WebServlet(name = "nuevaNoticia", urlPatterns = {"/nuevaNoticia"})
public class nuevaNoticia extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                if(idAdmin!=null){
                    os.write("ponernoticia#"+idAdmin+"#"+asunto+"\n");
                    os.newLine();
                    os.flush();
                    os.write(mensaje.replaceAll("\n", "<br />"));                
                }else{
                    throw new Exception("Debe loguearse como administrador crear noticias.");
                }
